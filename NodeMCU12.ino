...
#define WIFI_PASSWORD "Poojah55"           //Password of your wifi network 
...
void loop() 
{
  ...
  if(inch1 <=2)
  {
    Firebase.setString("Slot1","11");  
    Serial.println(inch1);
    Serial.println("Slot1 = 11");
  }
  else
  {
     Firebase.setString("Slot1","00"); 
     Serial.println("Slot1 = 00");
  }
  ...
  if(inch2 <=2)
  {
    Firebase.setString("Slot2","11"); 
    Serial.println("Slot2 = 11");
  }
  else
  {
     Firebase.setString("Slot2","00"); 
     Serial.println("Slot2 = 00");
  }
}
